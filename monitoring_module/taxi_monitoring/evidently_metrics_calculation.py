...
def calculate_metrics_postgresql(curr, i):
    ...
    # Ensure prediction column is correctly handled
    ...
    quantile =  result['metrics'][1]['result']['current']['value'].item()
    prediction_drift = result['metrics'][0]['result']['drift_score'].item()
